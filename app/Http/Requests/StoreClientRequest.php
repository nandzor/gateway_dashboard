...
class StoreClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'service_module' => ['nullable', 'integer'],
    ...
    public function messages(): array
    {
        return [
            ...
            'avkey_iv.max' => 'The avkey iv may not be greater than 100 characters.',
            'avkey_pass.max' => 'The avkey pass may not be greater than 100 characters.',
        ];
    }
}
