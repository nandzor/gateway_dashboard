...
@section('title', 'Edit Price Master')
@section('page-title', 'Edit Price Master')
    ...
    <x-card>
      <div class="p-6">
        <div class="flex items-center justify-between mb-6">
          <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Price Master</h1>
            <p class="text-gray-600 mt-1">Update pricing information for {{ $priceMaster->service_name }}</p>
          </div>
        ...
        <form method="POST" action="{{ route('price-masters.update', $priceMaster) }}" id="price-master-form">
          @csrf
          @method('PUT')
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <x-select
                ...
                :selected="old('module_id', $priceMaster->module_id)"
            ...
            <div>
              <x-input
                ...
                step="0.001"
                min="0"
                :value="old('price_default', $priceMaster->price_default)"
