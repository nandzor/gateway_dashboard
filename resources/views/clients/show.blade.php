      ...
      <div class="p-6 space-y-6">
          ...
          <div class="p-4 bg-gradient-to-r from-red-50 to-orange-50 rounded-lg border border-red-100">
            ...
            <div class="space-y-3">
              @if($client->white_list)
                <div>
                  <p class="text-sm font-medium text-gray-600 mb-2">White List</p>
                  <div class="flex flex-wrap gap-2">
                    @php
                      $ipList = is_string($client->white_list) ? explode(',', $client->white_list) : $client->white_list;
                      $ipList = array_filter(array_map('trim', $ipList));
                    @endphp
        ...
        <div class="flex items-center justify-between pt-4 border-t border-gray-200">
          ...
          <div class="flex space-x-3">
            ...
            @endif
            <x-button variant="secondary" :href="route('histories.by-client', $client)">
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
