...
@section('page-title', 'Edit Gateway Service')
      ...
      <form method="POST" action="{{ route('services.update', $service) }}">
        ...
        <div class="p-6 space-y-6">
          ...
          <div>
            ...
            <div class="space-y-2">
              <label class="flex items-center">
                <input type="radio" name="is_active" value="1" {{ old('is_active', $service->is_active) == '1' ? 'checked' : '' }} class="mr-2">
                <span class="text-sm text-gray-700">Active</span>
              </label>
              <label class="flex items-center">
                <input type="radio" name="is_active" value="0" {{ old('is_active', $service->is_active) == '0' ? 'checked' : '' }} class="mr-2">
          ...
          <div>
            ...
            <div class="space-y-2">
              <label class="flex items-center">
                <input type="radio" name="is_alert_zero" value="1" {{ old('is_alert_zero', $service->is_alert_zero) == '1' ? 'checked' : '' }} class="mr-2">
                <span class="text-sm text-gray-700">Yes - Alert when balance reaches zero</span>
              </label>
              <label class="flex items-center">
                <input type="radio" name="is_alert_zero" value="0" {{ old('is_alert_zero', $service->is_alert_zero) == '0' ? 'checked' : '' }} class="mr-2">
